        ...
        <div class="container">
            ...
            <div class="box">
               <form action="" method="POST">
                   ...
                   <input type="submit" name="submit" value="Ubah Profil" class="btn" style="background-color: #007BFF; color: white; border: none; padding: 10px 20px; cursor: pointer;">
               </form>
               <?php
            ...
            <div class="box">
               <form action="" method="POST">
                   ...
                   <input type="submit" name="ubah_password" value="Ubah Password" class="btn" style="background-color: #007BFF; color: white; border: none; padding: 10px 20px; cursor: pointer;">
               </form>
               <?php
